...
var moveScroll = function(obj1, obj2){
	...
	TweenMax.to(curScroll, 1, {y:($(obj1).offset().top) - obj2Height, onUpdate:function() { window.scrollTo(curScroll.x, curScroll.y); },  ease:Cubic.easeInOut, onComplete:function(){ }});
}
