...
function weekEnd(){
	$(".ui-datepicker td:first-child").addClass("sun");
	$(".ui-datepicker td:nth-child(7)").addClass("sat");
}
...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		$(".ui-datepicker").addClass("on");	
		$(".ui-datepicker-bg").fadeIn();
		weekEnd();		
	},
