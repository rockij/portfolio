...
$(function(){
	$('.tooltip_btn').hover(
		function(){
			$(this).parent().css('z-index','10').parent().parent().css('z-index','10').parents('.mp3_cont_box').css('z-index','10');
		}, function(){
			$(this).parent().removeAttr('style').parent().parent().removeAttr('style').parents('.mp3_cont_box').removeAttr('style');
		}
	);
});
...
function FigureMove(){
	...
	$container
		...
		.css('left', "210px"); /* for middle image */
